# Regenerating the full app.py with the corrected department chart
corrected_code = '''
...
with tab1:
    ...
    fig2 = px.bar(dept_counts, x='Department', y='Count', title="Department-wise Employee Count")
...
# Rewriting the app.py file after environment reset
corrected_code = '''
import streamlit as st
import pandas as pd
import seaborn as sns
